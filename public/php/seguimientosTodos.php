...
{
	$query = "SELECT * FROM SEGUIMIENTOS WHERE (SUCESO LIKE '%".$received_data->query."%' OR REQUERIMIENTO LIKE '%".$received_data->query."%' OR FECHA LIKE '%".$received_data->query."%') ORDER BY FECHA DESC";
}
else
{
	$query = "SELECT * FROM SEGUIMIENTOS WHERE 1" .$filtro ." ORDER BY FECHA DESC";
}
